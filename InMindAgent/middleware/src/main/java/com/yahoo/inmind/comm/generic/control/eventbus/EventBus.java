 ...
 */
package com.yahoo.inmind.comm.generic.control.eventbus;
...
public class EventBus {
    ...
    private synchronized void register(Object subscriber, boolean sticky, int priority) {
        List<SubscriberMethod> subscriberMethods = subscriberMethodFinder
                .findSubscriberMethods(subscriber.getClass());
        for (SubscriberMethod subscriberMethod : subscriberMethods) {
            Log.e("", "Registering: " + subscriber.getClass() );
    ...
    private boolean checkP2PSubscription( Object subscriber, Object event ) {
        ...
        try {
            Method method = clazz.getMethod( "getSubscriber" );
            if( method != null ) {
